...
public class PetEnderMite extends Pet {
	...
	public PetEnderMite(Player player) {
		super("Endermite", "§bEnderMite", player);
	...
	public void spawnPacket(Player target) {
		...
		spawnPacket.setType(EntityType.ENDERMITE);


		Location loc = getShoulder();
		
		WrappedDataWatcher watcher = WrappedUtils.getDefaultWatcher(loc.getWorld(), EntityType.ENDERMITE);
