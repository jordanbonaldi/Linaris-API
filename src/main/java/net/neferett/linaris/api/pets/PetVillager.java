...
public class PetVillager extends Pet {
	...
	public PetVillager(Player player) {
		super("Villageois", "§bVillageois", player);
	...
	public void spawnPacket(Player target) {
		...
		spawnPacket.setType(EntityType.VILLAGER);


		Location loc = getShoulder();
		
		WrappedDataWatcher watcher = WrappedUtils.getDefaultWatcher(loc.getWorld(), EntityType.VILLAGER);
