...
public class PetBat extends Pet {
	...
	public PetBat(Player player) {
		super("Chauve-Souris", "§bChauve-Souris", player);
	...
	public void spawnPacket(Player target) {
		...
		spawnPacket.setType(EntityType.BAT);


		Location loc = getShoulder();
		
		WrappedDataWatcher watcher = WrappedUtils.getDefaultWatcher(loc.getWorld(), EntityType.BAT);
