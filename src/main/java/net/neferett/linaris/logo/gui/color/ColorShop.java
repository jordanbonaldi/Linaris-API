...
public class ColorShop extends GuiScreen {
	...
	public void drawScreen() {
		...
		this.setItem(new ColorItems("Rouge", "§c", 150,
		...
		this.setItem(new ColorItems("Rouge foncé", "§4", 150,
		...
		this.setItem(new ColorItems("Or", "§6", 150,
		...
		this.setItem(new ColorItems("Jaune", "§e", this.pd.getRank().getVipLevel() == 4 ? 0 : 150,
		...
		this.setItem(new ColorItems("Vert", "§2", 100,
		...
		this.setItem(new ColorItems("Vert Clair", "§a", 100,
		...
		this.setItem(new ColorItems("Cyan", "§b", 100,
		...
		this.setItem(new ColorItems("Turquoise", "§3", 100,
		...
		this.setItem(new ColorItems("Bleu", "§1", this.pd.getRank().getVipLevel() == 3 ? 0 : 100,
		...
		this.setItem(new ColorItems("Bleu clair", "§9", 100,
		...
		this.setItem(new ColorItems("Rose", "§d", 100,
		...
		this.setItem(new ColorItems("Magenta", "§5", 100,
		...
		this.setItem(new ColorItems("Blanc", "§f", 100,
		...
		this.setItem(new ColorItems("Gris Clair", "§7", 100,
		...
		this.setItem(new ColorItems("Noir", "§0", 100,
		...
		this.setItem(new ColorEffectsItems("Barré", "§m", 50, new ItemStack(Material.WOOD_AXE), this.pd, this.name), 4,
				3);

		this.setItem(new ColorEffectsItems("Itallic", "§o", 100, new ItemStack(Material.STONE_AXE), this.pd, this.name),
				4, 4);

		this.setItem(
				new ColorEffectsItems("Sous-Ligné", "§n", 150, new ItemStack(Material.IRON_AXE), this.pd, this.name), 4,
				5);

		this.setItem(new ColorEffectsItems("Gras", "§l", 200, new ItemStack(Material.GOLD_AXE), this.pd, this.name), 4,
				6);

		this.setItem(new ColorEffectsItems("Magic", "§k", 250, new ItemStack(Material.DIAMOND_AXE), this.pd, this.name),
				4, 7);
		this.setItem(new ColorEffectsItems("Défaut", "", 0, new ItemStack(Material.BARRIER), this.pd, this.name), 5, 5);
