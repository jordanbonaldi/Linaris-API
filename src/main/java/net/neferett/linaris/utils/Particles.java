...
import net.neferett.linaris.utils.Particles.ParticleData;
import net.neferett.linaris.utils.ReflectionUtils.PackageType;
...
public enum Particles {
	...
	/**
	 * Represents the block data for the {@link Particles#BLOCK_CRACK} and
	 * {@link Particles#BLOCK_DUST} effects
	 * <p>
	...
	/**
	 * Represents the color for effects like {@link Particles#SPELL_MOB},
	 * {@link Particles#SPELL_MOB_AMBIENT} and {@link Particles#NOTE}
	 * <p>
	 * This class is part of the <b>ParticleEffect Library</b> and follows the
	 * same usage conditions
	 *
	...
	/**
	 * Represents the color for effects like {@link Particles#SPELL_MOB},
	 * {@link Particles#SPELL_MOB_AMBIENT}, {@link Particles#REDSTONE} and
	 * {@link Particles#NOTE}
	 * <p>
	 * This class is part of the <b>ParticleEffect Library</b> and follows the
	 * same usage conditions
	 ...
	 * {@link Particles#ITEM_CRACK}, {@link Particles#BLOCK_CRACK} and
	...
	public static final class ParticlePacket {
		...
		public static void initialize() throws VersionIncompatibleException {
			...
			try {
				...
				final Class<?> packetClass = PackageType.MINECRAFT_SERVER
		 ...
		 * @see #initialize()
		 */
		public ParticlePacket(Particles effect, float offsetX, float offsetY, float offsetZ, float speed, int amount,
		 ...
		 *            Indicates whether the maximum distance is increased from
		 *            256 to 65536
		 * @see #ParticleEffect(Particles, float, float, float, float, int,
		 ...
		 *      boolean, ParticleData)
		 */
		public ParticlePacket(Particles effect, Vector direction, float speed, boolean longDistance, ParticleData data)
				throws IllegalArgumentException {
			...
			try {
				...
				if (version < 8) {
					...
					if (this.data != null) {
						...
						ReflectionUtils.setValue(this.packet, true, "k", this.effect == Particles.ITEM_CRACK
	 ...
	 * @see ParticlePacket#ParticlePacket(Particles, Vector, float, boolean,
	 *      ParticleData)
	 * @see ParticlePacket#sendTo(Location, double)
	 */
