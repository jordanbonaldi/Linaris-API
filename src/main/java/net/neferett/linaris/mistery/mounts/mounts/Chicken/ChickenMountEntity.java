...
public class ChickenMountEntity extends EntityChicken {

	Mount mount;
	
    public ChickenMountEntity(World world) {
        super(world);
    }
    
    public ChickenMountEntity(World world,Mount mount) {
        super(world);
        this.mount = mount;
    }
    ...
    public static Chicken spawn(Location location) {
        ...
        final ChickenMountEntity customEntity = new ChickenMountEntity(mcWorld);
