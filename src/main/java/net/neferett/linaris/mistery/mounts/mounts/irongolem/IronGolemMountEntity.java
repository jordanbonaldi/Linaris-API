...
public class IronGolemMountEntity extends EntityIronGolem {

	Mount mount;

	public IronGolemMountEntity(World world) {
		super(world);
	}

	public IronGolemMountEntity(World world, Mount mount) {
		super(world);
		this.mount = mount;
	}
	...
	public static IronGolem spawn(Location location) {
		...
		final IronGolemMountEntity customEntity = new IronGolemMountEntity(mcWorld);
