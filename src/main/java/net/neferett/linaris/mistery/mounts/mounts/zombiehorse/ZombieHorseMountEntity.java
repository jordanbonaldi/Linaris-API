...
public class ZombieHorseMountEntity extends EntityHorse {

	Mount mount;
	
    public ZombieHorseMountEntity(World world) {
        super(world);
    }
    
    public ZombieHorseMountEntity(World world,Mount mount) {
        super(world);
        this.mount = mount;
    }
    ...
    public static Horse spawn(Location location) {
        ...
        customEntity.setVariant(3);
        Horse hh = (Horse) customEntity.getBukkitEntity();
        hh.setTamed(true);
        ((CraftLivingEntity) customEntity.getBukkitEntity()).setRemoveWhenFarAway(false);
        ((Horse) customEntity.getBukkitEntity()).setVariant(Variant.UNDEAD_HORSE);
