...
public class SpiderMountEntity extends EntitySpider {

	Mount mount;
	
    public SpiderMountEntity(World world) {
        super(world);
    }
    
    public SpiderMountEntity(World world,Mount mount) {
        super(world);
        this.mount = mount;
    }
    ...
    public static Spider spawn(Location location) {
        ...
        final SpiderMountEntity customEntity = new SpiderMountEntity(mcWorld);
