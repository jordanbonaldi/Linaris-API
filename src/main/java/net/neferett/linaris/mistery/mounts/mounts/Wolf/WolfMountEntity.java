...
public class WolfMountEntity extends EntityWolf {

	Mount mount;
	
    public WolfMountEntity(World world) {
        super(world);
    }
    
    public WolfMountEntity(World world,Mount mount) {
        super(world);
        this.mount = mount;
    }
    ...
    public static Wolf spawn(Location location) {
        ...
        final WolfMountEntity customEntity = new WolfMountEntity(mcWorld);
