...
public class CaveSpiderMountEntity extends EntityCaveSpider {

	Mount mount;
	
    public CaveSpiderMountEntity(World world) {
        super(world);
    }
    
    public CaveSpiderMountEntity(World world,Mount mount) {
        super(world);
        this.mount = mount;
    }
    ...
    public static CaveSpider spawn(Location location) {
        ...
        final CaveSpiderMountEntity customEntity = new CaveSpiderMountEntity(mcWorld);
