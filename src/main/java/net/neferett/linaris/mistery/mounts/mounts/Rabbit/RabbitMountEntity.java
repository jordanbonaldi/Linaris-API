...
public class RabbitMountEntity extends EntityRabbit {

	Mount mount;
	
    public RabbitMountEntity(World world) {
        super(world);
    }
    
    public RabbitMountEntity(World world,Mount mount) {
        super(world);
        this.mount = mount;
    }
    ...
    public static Rabbit spawn(Location location) {
        ...
        final RabbitMountEntity customEntity = new RabbitMountEntity(mcWorld);
