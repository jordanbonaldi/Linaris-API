...
public class SuperSheepEntity extends EntitySheep {

	Mount mount;
	
    public SuperSheepEntity(World world) {
        super(world);
    }
    
    public SuperSheepEntity(World world,Mount mount) {
        super(world);
        this.mount = mount;
    }
    ...
    public static Sheep spawn(Location location) {
        ...
        final SuperSheepEntity customEntity = new SuperSheepEntity(mcWorld);
