...
public class OcelotMountEntity extends EntityOcelot {

	Mount mount;
	
    public OcelotMountEntity(World world) {
        super(world);
    }
    
    public OcelotMountEntity(World world,Mount mount) {
        super(world);
        this.mount = mount;
    }
    ...
    public static Ocelot spawn(Location location) {
        ...
        final OcelotMountEntity customEntity = new OcelotMountEntity(mcWorld);
