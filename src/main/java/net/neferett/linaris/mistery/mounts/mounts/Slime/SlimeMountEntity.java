...
public class SlimeMountEntity extends EntitySlime {

	Mount mount;
	
    public SlimeMountEntity(World world) {
        super(world);
    }
    
    public SlimeMountEntity(World world,Mount mount) {
        super(world);
        this.mount = mount;
    }
    ...
    public static Slime spawn(Location location) {
        ...
        final SlimeMountEntity customEntity = new SlimeMountEntity(mcWorld);
