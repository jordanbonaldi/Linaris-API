...
public enum MountsUtils {
	...
	Blaze("Blaze", 6000, PriceType.TOKEN, RankType.VIPPLUS, new ItemStack(369), BlazeMount.class),
	CaveSpider("CaveSpider", 2000, PriceType.TOKEN, null, new ItemStack(375), CaveSpiderMount.class),
	Chicken("Poulet", 2000, PriceType.TOKEN, null, new ItemStack(344), ChickenMount.class),
	Cow("Vache", 2500, PriceType.TOKEN, null, new ItemStack(334), CowMount.class),
	Dog("Chien", 2500, PriceType.TOKEN, null, new ItemStack(352), WolfMount.class),
	Golem("Golem", 2500, PriceType.TOKEN, null, new ItemStack(265), IronGolemMount.class),
	HORSE("Cheval", 2500, PriceType.TOKEN, null, new ItemStack(383, 1, (short) 100), HorseMount.class),
	Pig("Cochon", 2000, PriceType.TOKEN, null, new ItemStack(398), PigMount.class),
	Rabbit("Lapin", 1500, PriceType.TOKEN, null, new ItemStack(415), RabbitMount.class),
	Sheep("Mouton", 1500, PriceType.TOKEN, RankType.VIP, new ItemStack(35, 1, (short) 10), SuperSheep.class),
	SKELETONHORSE(
			"Cheval Squelette",
			2000,
			PriceType.TOKEN,
	...
	Slime("Slime", 1500, PriceType.TOKEN, null, new ItemStack(341), SlimeMount.class),
	Spider("Araignée", 2500, PriceType.TOKEN, null, new ItemStack(30), SpiderMount.class),
	Wither("Wither", 5000, PriceType.TOKEN, RankType.EPICVIP, new ItemStack(397, 1, (short) 1), WitherMount.class),
	ZOMBIEHORSE(
			"Cheval Zombie",
			1500,
			PriceType.TOKEN,
